...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1744.9540576126835; // y position of the first parallel encoder (in tick units)
        public double par1YTicks =  1569.030618154412; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =
                -1335.433515958388; // x position of the perpendicular encoder (in tick units)
    }
