...
public class RedCloseCoordinates {

    private static final double startX = -56.5;
    private static final double startY = 45.5;
    private static final double startPoseHeading = Math.toRadians(145);
    ...
    private static final double firstIntakeStartHeading = Math.toRadians(89);


    private static final double shootingX = -18;
    private static final double shootingY = 11;
    private static final double shootingHeading = Math.toRadians(145);
